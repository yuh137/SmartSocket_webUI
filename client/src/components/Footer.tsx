    ...
    <footer className="h-fit bg-[#7ED7C1] flex items-center text-[#333] py-6">
      <div className="footer_left_panel flex flex-col w-2/3">
        <img
          src="/smartsocket.png"
          alt=""
          className="grow-0 max-h-24 w-fit scale-50 -translate-x-24"
        />
        <div className="placeholder-text w-2/3 translate-x-20 mb-6">
          The smart power socket, with an RS-485 connected power measuring unit
          and a controller board, calculates and displays real-time power usage.
          It also features internet connectivity for remote monitoring via a web
          interface.
        </div>
      ...
      <div className="footer_right_panel">
        <ul className="flex flex-col gap-4">
          ...
          <li className="w-72">
            Address: 268 Ly Thuong Kiet St, District 10, Ho Chi Minh City,
            Vietnam
          </li>
        </ul>
      </div>
